    ...
    <svg width="46" height="46" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2_1409)">
        ...
        <g filter="url(#filter0_d_2_1409)">
          <path
            d="M27.3909 16.6646C27.3909 16.6646 33.1079 15.7394 34.0107 13.0411H25.2531V10.9H6.01074L8.38117 13.7229V16.6152C8.38117 16.6152 14.3623 16.296 16.6759 18.0965C19.8429 21.1092 13.114 25.1814 13.114 25.1814L11.9602 29.1C13.7645 27.3367 17.2033 25.0558 23.5084 25.1657C21.109 25.944 18.6964 27.1596 16.8182 29.1H29.5638L28.3636 25.1814C28.3636 25.1814 19.1258 19.5907 27.3909 16.6646Z"
            fill="#F16436"/>
        </g>
      </g>
