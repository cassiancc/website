...
<Cards>
  ...
  <Cards.Card
    ...
    title="Developers"
    href="/docs/connector/developers"
  />
  <Cards.Card
    icon={<Stars/>}
...
<Callout type="error" emoji="🐛">
  Please don't report issues encountered while using Connector to mod authors, as it only puts unnecessary strain on their management.
